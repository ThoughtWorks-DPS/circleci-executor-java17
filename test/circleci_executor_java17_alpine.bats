...
#  [[ "${output}" =~ "libintl-0.21-r0" ]]
  [[ "${output}" =~ "openjdk17-jre-17.0.2_p8-r1" ]]
  [[ "${output}" =~ "openjdk17-jdk-17.0.2_p8-r1" ]]
  [[ "${output}" =~ "openjdk17-17.0.2_p8-r1" ]]
  [[ "${output}" =~ "openjdk16-jre-16.0.2_p7-r1" ]]
  [[ "${output}" =~ "openjdk16-jdk-16.0.2_p7-r1" ]]
  [[ "${output}" =~ "openjdk16-16.0.2_p7-r1" ]]
  [[ "${output}" =~ "openjdk11-jre-11.0.14_p9-r0" ]]
  [[ "${output}" =~ "openjdk11-jdk-11.0.14_p9-r0" ]]
  [[ "${output}" =~ "openjdk11-11.0.14_p9-r0" ]]
